  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-5">
      {techStack.map((tech, index) => (
        <motion.div
          key={index}
          className="flex items-center gap-4 rounded-lg border bg-neutral-100 border-neutral-700 dark:bg-neutral-900 p-4 transition-colors duration-300 cursor-pointer"
          whileHover={{
            scale: 1.03,
